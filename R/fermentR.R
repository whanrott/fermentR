...
#'
#' \enumerate{
#' \item Converting between units of gravity (which measure concentration of sugars in water).
#' \item Calculating useful characteristics water chemistry and suggesting treatment (planned).
#' \item Calculating composition and temperature of mashes.
#' \item Calculating usage and effect of hops.
#' \item Calculating amounts of alcohol in fermented worts.
#' \item Calculating gas volumes in fermented worts and suggesting gas line lengths to control dispense (planned).
#' }
#'
